...
class ParticipationTest extends \PHPUnit_Framework_TestCase {
	...
	public function testSettingDefaultTemplate() {
		...
		$this->assertEquals($this->baseDir . '/Participation/views/default.html', $widget->getViewFile(),
	...
	public function testSettingTemplateFromViewProperty() {
		...
		$this->assertEquals($this->baseDir . '/Participation/views/my-test-view.html', $widget->getViewFile(),
